...
import { Box, Typography, Button, Container, Grid, useTheme, Divider, Chip, Avatar } from '@mui/material';
    ...
    <Container maxWidth="lg" sx={{ py: 6 }}>
      <Grid container spacing={4} alignItems="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="h5" component="h2" gutterBottom sx={{ fontWeight: 600 }}>
            The AI-Powered Learning Engine for Tech & Science
          </Typography>
          
          <Typography variant="body1" paragraph sx={{ mb: 2, fontSize: '1.1rem' }}>
            Lernix LMs (Learning Machines) is revolutionizing technology education through adaptive AI that 
            personalizes learning paths for coding, data science, AI/ML, and advanced sciences.
          </Typography>
      ...
      <Box sx={{ mt: 8 }}>
        ...
        <Grid container spacing={3} sx={{ mt: 3 }}>
          {[
            { icon: <CodeIcon fontSize="large" />, title: "Programming", desc: "From Python to Rust" },
            { icon: <SmartToyIcon fontSize="large" />, title: "AI/ML", desc: "Machine Learning to Deep Learning" },
            { icon: <ScienceIcon fontSize="large" />, title: "Data Science", desc: "Analytics to Visualization" },
          ].map((domain, index) => (
        ...
        <Grid container spacing={4} sx={{ mt: 2 }}>
          {[
            ...
            },
            {
              ...
              description: "Curriculum updated quarterly with latest tech trends"
            },
            {
            ...
            },
            {
              ...
              description: "Collaborate with 5K+ developers and data scientists"
            },
            {
      ...
      <Box sx={{ 
        ...
        <Typography variant="body1" paragraph sx={{ mb: 4, fontSize: '1.1rem' }}>
          Join our community of developers and scientists learning with AI-powered LMs.
        </Typography>
        <Button
          variant="contained"
          size="large"
